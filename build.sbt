...
libraryDependencies += ("org.scalactic" %% "scalactic" % "3.2.15").cross(CrossVersion.for3Use2_13)
libraryDependencies += ("org.scalatest" %% "scalatest" % "3.2.15" % "test").cross(CrossVersion.for3Use2_13)
