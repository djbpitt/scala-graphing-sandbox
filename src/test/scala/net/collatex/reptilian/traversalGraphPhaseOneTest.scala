...
/** Set up fixtures
  *
  * blocks copied from first paragraph of six Darwin witnesses longestFullDepthNonrepeatingBlocks
  */
...
class traversalGraphPhaseOneTest extends AnyFunSuite:
  ...
  test("Compute block offsets in all witnesses") {
