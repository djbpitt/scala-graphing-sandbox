...
/** Ported from scala 2.11 to scala 3.2.2 by Ronald Haentjens Dekker and David J. Birnbaum
 * Original source: https://github.com/hammerlab/suffix-arrays/blob/master/src/main/scala/org/hammerlab/suffixes/dc3/DC3.scala
